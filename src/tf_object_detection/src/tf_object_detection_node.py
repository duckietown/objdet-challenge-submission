...
class ObjectDetectionNode:
    def __init__(self):
        ...
        self.__image_pub = rospy.Publisher('/'+os.environ['DUCKIEBOT_NAME']+'/prediction_images', CompressedImage, queue_size=1)
        ...
        self.__image_sub = rospy.Subscriber('/'+ os.environ['DUCKIEBOT_NAME'] + "/camera_node/image/compressed",CompressedImage, self.Imagecallback)
